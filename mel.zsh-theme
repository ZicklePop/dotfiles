...
local ret_status="%(?:%{$fg_bold[blue]%}m%{$reset_color%}%{$fg_bold[magenta]%}e%{$reset_color%}%{$fg_bold[white]%}l%{$reset_color%}:%{$fg_bold[white]%}m%{$reset_color%}%{$fg_bold[magenta]%}e%{$reset_color%}%{$fg_bold[blue]%}l%{$reset_color%}%s)"
